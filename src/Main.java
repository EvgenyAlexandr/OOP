public class Main {
    public static void main(String[] args) {
        ...
        Gryffindor garry    = new Gryffindor("Гарри Поттер",        80, 85, 85, 90, 100);
        ...
        Slytherin drako     = new Slytherin("Драко Малфой",   85, 80, 70, 85, 85, 85, 85);
        Slytherin graham    = new Slytherin("Грэхэм Монтегю", 80, 70, 85, 95, 50, 80, 70);
        Slytherin gregory   = new Slytherin("Грегори Гойл",   75, 75, 85, 95, 75, 80, 90);
